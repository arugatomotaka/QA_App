...
import jp.techacademy.tomotaka.aruga.qa_app.databinding.ListAnswerBinding
import jp.techacademy.tomotaka.aruga.qa_app.databinding.ListQuestionDetailBinding
...
class QuestionDetailListAdapter(context: Context, private val question: Question) : BaseAdapter() {
    ...
    private fun favoriteprocess(question: Question){
